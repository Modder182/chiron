...
<head>
  ...
  <title>Bugatti Chiron Project</title>
...
<body>
  ...
  <section class="video">
    <div class="container">
      <iframe width="100%" height="400" src="https://www.youtube.com/embed/PkkV1vLHUvQ" frameborder="0"
        ...
        <div class="design-row">
          <div class="design-row__item">
            ...
            <div class="design-row__item-text">
              Новый Широн был разработан бывшим дизайнером Bugatti
              Александром Селипановым. 
              Имеет закрытую крышу и кузов с двумя передними 
              сиденьями и без cидений сзади.
          </div>
        </div>
        <div class="design-row__item">
            <div class="design-row__item-num">02</div>
            <div class="design-row__item-text">
              Широн имеет один электродвигатель, под капотом.
              Они обеспечивают полный привод, а также систему адресного 
              распределения крутящего момента для лучшего прохождения 
              поворотов.
          </div>
        </div>
      </div>
